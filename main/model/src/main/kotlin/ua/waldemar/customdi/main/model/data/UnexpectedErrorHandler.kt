...
internal fun Throwable.asUnexpectedErrorOrNull(
...
internal fun Result<*>.asUnexpectedErrorOrNull(
    vararg expectedErrorCode: String
): UnexpectedError? {
    return exceptionOrNull()?.asUnexpectedErrorOrNull(*expectedErrorCode)
}

internal suspend fun <T> Result<T>.onUnexpectedErrorNull(
    vararg expectedErrorCode: String,
...
internal suspend fun <T> Result<T>.onUnexpectedError(
    vararg expectedErrorCode: String,
    onUnexpectedError: suspend (error: UnexpectedError) -> Unit
): Result<T> = apply {
...
internal suspend fun <T> Result<T>.onUnexpectedErrorOrNull(
    vararg expectedErrorCode: String,
